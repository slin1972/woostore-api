...
public class RandomValidateCode {
    ...
    private final static Font font = new Font("Fixedsys",Font.CENTER_BASELINE,18);
    /*
     * 获得颜色
     */
	...
	public static boolean isCorrect(String randomCode,HttpSession session) {
		if(!StringUtils.isEmpty(randomCode)){
			String lastRandomCode = (String) session.getAttribute(RANDOMCODEKEY);
			if(randomCode.equalsIgnoreCase(lastRandomCode)){
